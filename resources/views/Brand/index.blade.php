    ...
    <div class="x_panel">
        ...
        <div class="x_title">
          ...
          <ul class="nav navbar-right panel_toolbox">
            <li>
                <input type="button" class="btn btn-primary" value="New Brand" onclick="window.location.href='/brands/create'" />
            </li>
          </ul>
      ...
      "columns":[
        ...
        },
        {
          ...
          render: function ( data, type, row ) {
            return '<button type="button" class="btn btn-default" onclick="editBrand(\''+data.Id+'\')">Edit</button>'
               ...
               headers: {
                ...
                success:function(data){
                    if(data.errors != undefined && data.errors.length > 0){
                      ...
                      toastr.success('Brand deleted','success', {timeOut: 3000});
                      $("#btnCancel").click();
                      table.ajax.reload();
                    }
                },
