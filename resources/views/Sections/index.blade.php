    ...
    <div class="x_panel">
        ...
        <div class="x_title">
          ...
          <ul class="nav navbar-right panel_toolbox">
            <li>
                <input type="button" class="btn btn-primary" value="New Section" onclick="window.location.href='/Section/Add'" />
            </li>
          </ul>
        ...
        <div class="x_content">
          ...
          <table class="table" id="tblSections">
            <thead>
              <tr>
                <th>Name</th>
                <th>Description</th>
...
@section('js')
  ...
  <script>
    ...
    $(document).ready(function(){
      table = $("#tblSections").DataTable({
        "pageLength": 30,
        "processing": true,
        "serverSide": true,
        "ajax": "{{route('api.getSections')}}",
        "columns":[
          {
            "width": "20%",
            "data":"Name",
          ...
          },
          {
            ...
            render: function ( data, type, row ) {
              return '<button type="button" class="btn btn-default" onclick="editSection(\''+data.Id+'\')">Edit</button>'
      ...
      $("#btnDelete").click(function(){
        var catId = $("#delId").val();
        console.log('/Section/Delete/' + catId);
        $.ajax({
                 headers: {
                  ...
                  async:false,
                  type:'GET',
                  url:'/Section/Delete/' + catId,
                  success:function(data){
                      if(data.errors != undefined && data.errors.length > 0){
                        showErrorMessage(data.errors);
                      }else{
                        toastr.success('Section deleted','success', {timeOut: 3000});
                        $("#btnCancel").click();
                        table.ajax.reload();
                      }
                  },
    ...
    function editSection(id){
      window.location.href = '/Section/Edit/' + id;
    }
