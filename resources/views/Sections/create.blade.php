        ...
        <form id="frmSection" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" name="section" id="section" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
                 ...
                 headers: {
                  ...
                  success:function(data){
                      if(data.errors != undefined && data.errors.length > 0){
                        ...
                        toastr.success('New Section created','success', {timeOut: 3000});
