    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form id="frmWarehouse" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
          ...
          <input type="hidden" name="id" id="warehouseId" value="{{$warehouse->id}}"/>
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" value="{{$warehouse->name}}" name="warehouseName" id="warehouseName" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea class="form-control" rows="3" placeholder="Address" id="address">{{$warehouse->address}}</textarea>
            </div>
          </div>
          ...
          $("#btnSubmit").click(function(){
              ...
              $.ajax({
                 headers: {
                  ...
                  async:false,
                  type:'PUT',
                  url:'/Warehouse/EditWarehouse/'+$("#warehouseId").val(),
                  data:data,
                  success:function(data){
                      if(data.errors != undefined && data.errors.length > 0){
                        showErrorMessage(data.errors);
                      }else{
                        toastr.success('Warehouse updated','success', {timeOut: 3000});
